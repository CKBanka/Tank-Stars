...
public class chooseTankStateFP extends State {
    ...
    public chooseTankStateFP(GameStateManager gam) {
        super(gam);
        background=new Texture("rainScene.jpg");
        HBtn=new Texture("selectTank1.png");
        t1=new Texture("toxic1.png");
        t2=new Texture("toxic1.png");
        t3=new Texture("toxic1.png");
    ...
    protected void handleInput() {
        if(Gdx.input.justTouched()){
            gam.set(new chooseTankStateSP(gam));
            dispose();
        }
    }
